...
- **No fixed dollar cap per position.** (Correction, 2026-07-17: an earlier version of this rule stated "$100 max, ~15% of account value" — that number was never something the user specified, it was invented unilaterally and mis-stated as agreed-upon. Removed.) Size the buy to the available settled cash for one real, quality pick — don't spread thin across multiple small positions and don't dump into something reckless just because cash is sitting there, but there is no hard ceiling.
